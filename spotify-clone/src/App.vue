...
<template>
    <div>
        ...
        >
            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://avatars.githubusercontent.com/u/76525056?v=4"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">FanatII - Mandla</div>
            ...
            <span v-if="openMenu"
                class="fixed w-[190px] bg-[#000] shadow-2xl z-50 rounded-sm top-[52px] right-[35px] p-1 cursor-pointer">
                <ul class="text-gray-200 font-semibold rounded-lg text-[14px]">
                    <li class="px-3 py-2.5 hover:bg-[#373737] border-b border-b-gray-600">Profile</li>
                    <li class="px-3 py-2.5 hover:bg-[#373737]">Log out</li>
                </ul>
            </span>
        </div>
        ...
        <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
            <RouterLink to="/">
              <img width="125" src="/images/icons/music-player.png">
            </RouterLink>
            <div class="my-8"></div>
            <ul>
                <RouterLink to="/">
